...
def generate_stakeholder_venn():
    try:
        ...
        circle1 = Circle(circle1_center, radius, fill=True,
                         facecolor=color_poder,
                         edgecolor='darkred', linewidth=2.5, alpha=0.5, zorder=1)
        circle2 = Circle(circle2_center, radius, fill=True,
                         facecolor=color_legitimidad,
                         edgecolor='darkblue', linewidth=2.5, alpha=0.5, zorder=1)
        circle3 = Circle(circle3_center, radius, fill=True,
                         facecolor=color_urgencia,
